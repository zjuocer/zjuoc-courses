...
大二是海洋学院专业课逐渐展开的阶段。本目录会优先整理专业核心课的回忆卷、课程资源、课程评价和课件/课程材料。
...
已创建完整的六类资料分支，并收录 25-26 回忆卷。

[进入课程](./ocai/){ .md-button .md-button--primary }
...
已创建课程主页、历年卷、课程资源、课程评价、课件/课程材料、期中汇报等板块。
...
已创建课程主页、历年卷、课程资源、课程评价、课件/课程材料等板块。
